...
func (in *ReplicationSourceSyncthingSpec) DeepCopyInto(out *ReplicationSourceSyncthingSpec) {
	*out = *in
	if in.DeviceList != nil {
		...
		*out = make([]*SyncthingDevice, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SyncthingDevice)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncthingDevice) DeepCopyInto(out *SyncthingDevice) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncthingDevice.
func (in *SyncthingDevice) DeepCopy() *SyncthingDevice {
	if in == nil {
		return nil
	}
	out := new(SyncthingDevice)
