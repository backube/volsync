...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SourceTriggerSpec) DeepCopyInto(out *SourceTriggerSpec) {
	*out = *in
	if in.Schedule != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SourceTriggerSpec.
func (in *SourceTriggerSpec) DeepCopy() *SourceTriggerSpec {
	if in == nil {
		return nil
	}
	out := new(SourceTriggerSpec)
	in.DeepCopyInto(out)
	return out
}
